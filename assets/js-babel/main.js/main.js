...
$(document).ready(function () {
  // mobile menu
  var headerBtn = document.querySelector('.js-header-menu-btn'); // кнопка открытия мобильного меню сбоку 

  var headerMenu = document.querySelector('.js-header-menu');
  var headerWrapper = document.querySelector('.js-menu-wrapper');
